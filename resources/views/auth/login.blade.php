    ...
    <div class="mx-auto h-full flex justify-center items-center bg-gray-300">
        <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
            ...
            <form class="pt-8" method="POST" action="{{ route('login') }}">
                ...
                <div class="relative">
                    <label for="email"
                           class="uppercase pl-3 pt-2 text-blue-500 text-xs font-bold absolute">Email</label>

                    <div class="col-md-6">
                        <input
                            placeholder="youremail@com"
                            id="email" type="email"
                            class="pt-8 w-full outline-none focus:bg-blue-700 text-gray-100 rounded p-3 bg-blue-800"
                            name="email" value="{{ old('email') }}" autocomplete="email" autofocus>

                        @error('email')
                        <span class="text-red-300 text-sm pt-1" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
                </div>
                ...
                <div class="relative pt-3">
                    <label for="password"
                           class="uppercase pl-3 pt-2 text-blue-500 text-xs font-bold absolute">Password</label>
                    ...
                    <div class="col-md-6">
                        ...
                        @error('password')
                        <span class="text-red-300 text-sm pt-1" role="alert">
                ...
                <div class="pt-8">
                    <button
                        type="submit"
                        class="w-full bg-gray-100 py-2 px-3 text-left uppercase rounded text-blue-800 font-bold">
                        Login
                    </button>
                </div>
