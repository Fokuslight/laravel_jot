            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <router-link to="/contacts/create"
                                 class="text-sm hover:text-blue-600 flex items-center py-2">
                        ...
                        <div class="tracking-tight pl-3">Add New</div>
                    </router-link>
                    ...
                    <router-link to="/contacts"
                        ...
                        <div class="tracking-tight pl-3">Contacts</div>
                    </router-link>
                    <router-link to="/birthdays"
                        ...
                        <div class="tracking-tight pl-3">Birthdays</div>
                    </router-link>
                    ...
                    <router-link to="/logout"
                        ...
                        <div class="tracking-tight pl-3">Logout</div>
                    </router-link>
                </nav>
            </div>
